...
aws cloudformation create-stack --template-body file://./csye6225-infra.json --stack-name ${stackname} --capabilities "CAPABILITY_NAMED_IAM" --parameters ParameterKey=AMI,ParameterValue="$ami"
